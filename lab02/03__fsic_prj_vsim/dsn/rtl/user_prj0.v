...
.sw_in                   (reg_sw_in         ), //I
.crc32_hw_pix_in_rsc_dat    (crc32_stream_in   ), //O
.crc32_hw_pix_in_triosy_lz  (),                   //O, not useful
.crc32_hw_pix_out_rsc_dat   (crc32_stream_out  ), //O
.crc32_hw_pix_out_triosy_lz (edgedetect_done   ), //O
.din_chn_rsc_dat          (dat_in_rsc_dat    ), //I
.din_chn_rsc_vld          (ss_tvalid         ), //I
.din_chn_rsc_rdy          (dat_in_rsc_rdy    ), //O
.dout_chn_rsc_dat         (dat_out_rsc_dat   ), //O
.dout_chn_rsc_vld         (sm_tvalid         ), //O
